...
export function VisitorPresence() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-line bg-white/70 px-3 py-1 text-sm text-ink backdrop-blur dark:border-moss dark:bg-ink dark:text-paper">
